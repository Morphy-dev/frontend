        ...
        <ul className="flex flex-col h-auto overflow-y-auto custom-scrollbar">
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                  A student <b className="text-gray-800 dark:text-white/90">John Doe</b> started a lesson.
                </span>
          ...
          <li>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                  <b className="text-gray-800 dark:text-white/90">Anna Smith</b> completed a lesson.
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
          ...
          <li>
            ...
            >
              ...
              <span className="block">
                <span className="mb-1.5 block text-theme-sm text-gray-500 dark:text-gray-400">
                  New student <b className="text-gray-800 dark:text-white/90">Michael Lee</b> joined your group.
                </span>
                <span className="flex items-center gap-2 text-gray-500 text-theme-xs dark:text-gray-400">
